...
BUILDER_2604_PATTERNS=("docker/ubuntu-2604-builder.Dockerfile .github/workflows/builder-ubuntu.yml")
...
run_2604="0"
for pattern in ${BUILDER_2604_PATTERNS[@]}; do
    if matches_pattern $pattern; then
        run_2604="1"
        break
    fi
...
echo "${run_tc} ${run_2204} ${run_2404} ${run_2604} ${run_contrib}"
